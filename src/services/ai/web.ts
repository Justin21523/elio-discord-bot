...
export async function search(query: string, { top = 6 }: { top?: number } = {}): Promise<any> {
  const payload = {
    query,
    top,
...
export async function searchWithFilters(
  query: string,
  {
    ...
    recencyDays = null,
    domains = [],
  }: { maxResults?: number; recencyDays?: number | null; domains?: string[] } = {}
): Promise<any> {
  const payload = {
    query,
 ...
 * @returns {Promise<{ok: true, data: Array} | {ok: false, error: Object}>}
 */
export async function searchYouTube(query: string, maxResults = 5): Promise<any> {
 ...
 * @returns {Promise<{ok: true, data: Array} | {ok: false, error: Object}>}
 */
export async function searchReddit(query: string, subreddits: string[] = [], maxResults = 5): Promise<any> {
 ...
 * @returns {Promise<{ok: true, data: Array} | {ok: false, error: Object}>}
 */
export async function searchNews(query: string, maxResults = 5): Promise<any> {
  return searchWithFilters(query, {
    maxResults,
    recencyDays: 7,
 ...
 * @returns {Promise<{ok: true, data: Array} | {ok: false, error: Object}>}
 */
export async function searchTwitter(query: string, maxResults = 5): Promise<any> {
  return searchWithFilters(query, {
    maxResults,
    recencyDays: 3,
