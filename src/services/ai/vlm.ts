 ...
 */
export async function describe(params: any): Promise<any> {
  const {
    imageUrl,
    task = "caption",
    tone = "neutral",
 ...
 */
export async function imageReact(params: any): Promise<any> {
  const {
    imageUrl,
    personaName,
    context,
 ...
 */
export async function analyze(params: any): Promise<any> {
  const {
    imageUrl,
    prompt,
 ...
 */
export async function react(params: any): Promise<any> {
  const {
    imageUrl,
    persona,
    style = "engaging",
 ...
 */
export async function ask(params: any): Promise<any> {
  const {
    imageUrl,
    question,
    maxTokens = AI_MAX_TOKENS,
