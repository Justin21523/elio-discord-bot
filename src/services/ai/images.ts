...
export async function captionB64(
  image_b64: string,
  max_length = 80,
...
export async function captionUrl(
  url: string,
  max_length = 80,
  opts: Record<string, unknown> = {}
): Promise<any> {
 ...
 */
export async function describe(input: any): Promise<any> {
