 ...
 */
export async function reasoning(params: any): Promise<any> {
  const {
    problem,
    context,
 ...
 */
export async function taskPlanning(params: any): Promise<any> {
  const {
    goal,
    constraints,
    availableTools,
 ...
 */
export async function multiTask(params: any): Promise<any> {
  const {
    tasks,
 ...
 */
export async function webSearch(params: any): Promise<any> {
  const {
    query,
    numResults = 5,
    recencyDays,
  ...
  try {
    ...
    return {
      ...
      error: {
        ...
        details: { cause: getErrorMessage(error), kind },
      },
    };
  }
}
 ...
 */
export async function personaChallenge(params: any): Promise<any> {
  const {
    personaName,
    messages,
    maxReplies = 5,
