...
export async function getStatus() {
  try {
    ...
    try {
      ...
      logError(getErrorMessage(cause), { phase: "ai_health_fetch", url: AI_HEALTH_URL });
    }
    ...
    try {
      ...
      logError(getErrorMessage(cause), { phase: "db_ping_or_counts" });
    }
