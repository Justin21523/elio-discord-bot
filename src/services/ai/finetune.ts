 ...
 */
export async function startTraining(params: any): Promise<any> {
  const {
    jobName,
    baseModel,
    datasetPath,
 ...
 * @returns {Promise<{ok: true, data: object} | {ok: false, error: object}>}
 */
export async function listJobs(options: any = {}): Promise<any> {
 ...
 * @returns {Promise<{ok: true, data: object} | {ok: false, error: object}>}
 */
export async function hyperparameterTuning(params: any): Promise<any> {
  const {
    baseModel,
    datasetPath,
    taskType,
 ...
 * @returns {Promise<{ok: true, data: object} | {ok: false, error: object}>}
 */
export async function registerModel(params: any): Promise<any> {
  const {
    modelPath,
    versionName,
    metadata,
 ...
 * @returns {Promise<{ok: true, data: object} | {ok: false, error: object}>}
 */
export async function prepareDataset(params: any): Promise<any> {
  const {
    rawDataPath,
    outputPath,
    formatType,
