 ...
 */
export function removeFormatLeakage(
  text: string,
 ...
 */
export function fixThirdPersonPronouns(text: string, personaName: string): string {
 ...
 */
export function detectThirdPerson(text: string, personaName: string): boolean {
...
export function ensureCompleteSentence(text: string): string {
  ...
  if (lastChar && sentenceEnders.includes(lastChar)) {
    return trimmed;
  }
