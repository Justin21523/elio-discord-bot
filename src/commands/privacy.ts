...
async function handleSettings(interaction: any, privacyManager: any) {
...
async function handleOptOut(interaction: any, privacyManager: any) {
...
async function handleOptIn(interaction: any, privacyManager: any) {
  const type = interaction.options.getString('type');
  const userId = interaction.user.id;
  const guildId = interaction.guildId;
...
async function handleDelete(interaction: any, privacyManager: any) {
